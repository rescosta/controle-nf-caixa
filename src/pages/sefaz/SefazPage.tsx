...
import { FileText, Building2, Mail, Briefcase, Calculator } from 'lucide-react'
...
import TributosPage from './TributosPage'

type SubTab = 'nfes' | 'nfse' | 'tributos' | 'empresas' | 'destinatarios'
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="bg-slate-850 border-b border-slate-700 flex items-center gap-1 px-4 shrink-0" style={{ background: 'rgb(15 23 42 / 0.7)' }}>
        ...
        <SubNavTab id="tributos" active={sub} icon={<Calculator size={14} />} label="Impostos" onClick={setSub} />
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {sub === 'tributos' && <div className="h-full overflow-auto"><TributosPage /></div>}
